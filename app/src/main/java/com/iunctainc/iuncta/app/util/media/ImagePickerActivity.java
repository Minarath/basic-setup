...
import com.iunctainc.iuncta.app.util.permission.PermissionHandler;
import com.iunctainc.iuncta.app.util.permission.Permissions;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        String[] animals = {"Take camera picture", "Choose from gallery"};
