package com.iunctainc.iuncta.app.util.databinding;//package com.bct.flexcheckauto.util.databinding;
...
public class TextViewBindingAdapter {
    ...
    @BindingAdapter({"valid_password"})
    public static void valid_password(TextView textView, Boolean valid) {
        if (valid != null && valid) {
            textView.setTextColor(ContextCompat.getColor(textView.getContext(), R.color.header));
            textView.setPaintFlags(textView.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        } else {
            textView.setTextColor(ContextCompat.getColor(textView.getContext(), R.color.divider));
            textView.setPaintFlags(Paint.ANTI_ALIAS_FLAG);
        }
    }

    @BindingAdapter({"html_text"})
    public static void valid_password(TextView textView, String text) {
        if (text != null) {
    ...
    @BindingAdapter({"strike_throw"})
    public static void strike_throw(TextView textView, String text) {
        if (text != null) {
            textView.setText(Html.fromHtml(text));
            textView.setPaintFlags(textView.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        } else {
    ...
    public static void appointmentStatus(TextView textView, String s) {
        if (s != null) {
            switch (s) {
                case "1":
                    textView.setTextColor(ContextCompat.getColor(textView.getContext(), R.color.green_confirmed));
                    textView.setText("Confirmed");
                    break;
                case "2":
                    textView.setTextColor(ContextCompat.getColor(textView.getContext(), R.color.pink_dark));
    ...
    @BindingAdapter({"appointment_date"})
    public static void appointmentDate(TextView textView, String s) {
        if (s != null) {
            try {
                String format = new SimpleDateFormat("dd MMM yyyy", Locale.US).format(new SimpleDateFormat("yyyy-MM-dd", Locale.US).parse(s));
    ...
    public static void connection(TextView textView, ConnectionBean bean) {
        if (bean == null)
            textView.setVisibility(View.GONE);
        else if (bean.isConnected()) {
