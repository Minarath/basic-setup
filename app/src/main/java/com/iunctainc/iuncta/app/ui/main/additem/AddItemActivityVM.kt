...
class AddItemActivityVM @Inject constructor(private val dashRepo: DashRepo, private val networkErrorHandler: NetworkErrorHandler) : BaseViewModel() {
    ...
    fun obrAddItem(
        ...
        name: String,
        barcode: String,
        location: String,min_stock: Int
    ) {
        dashRepo.addItemAsync(company_id, sales_price, cost_price, opg_stock, vat, discount, category1_id, category2_id, category3_id, name, barcode, location,min_stock, object : ApiCallback<Response<AddItemResponse>>() {
